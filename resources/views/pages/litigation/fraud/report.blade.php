    ...
    <div class="flex flex-col white">
        ...
        <div class="mx-1 outline outline-offset-0 outline-2">
            ...
            <div class="bg-[#808080] grid grid-flow-row auto-rows-max grid grid-flow-col auto-cols-max py-1">
                ...
                <h1 class="text-white">CONNOTE NUMBER</h1>
            </div>
            <div class="grid grid-flow-row auto-rows-max py-1">
                <h1 class="text-black grid place-items-center">test case</h1>
            </div>
        ...
        <form action="" method="post">
            <div class="mx-20">
                ...
                <div class="flex my-5 place-items-center">
                    <label for="text"
                        class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Bentuk
                        Kiriman</label>
                    <div class="flex-[2]">
                        <select id="countries"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-8/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="grid grid-rows-2 grid-flow-col gap-4 mb-4">
                    <div class="row-span-4 grid gap-4">
                        <div class="grid grid-cols-4 grid-flow-col">
                            ...
                            <div class="grid grid-rows-4 grid-flow-col col-span-3">
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Keterangan
                                            Saksi</label>
                                        <div class="flex-[2]">
                                            <select id="countries"
                                ...
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Dokumen
                                            Surat</label>
                                        <div class="flex-[2]">
                                            <select id="countries"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/5 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Lain-lain</label>
                                        <div class="flex-[2]">
                                            <select id="countries"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/5 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option>-- Pilih --</option>
                ...
                <div class="flex flex-col gap-4 mb-4">
                    <div class="flex my-5 place-items-center">
                        <label for="text"
                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Barang
                            Bukti</label>
                        <div class="flex-[2]">
                            <select id="countries"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-8/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="flex place-items-center">
                        <label for="text"
                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Kelengkapan</label>
                        <div class="flex-[2]">
                            <select id="countries"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-8/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option>-- Pilih --</option>
                    ...
                    <div class="flex my-5 place-items-center">
                        <label for="text"
                            class="flex items-center flex-[1] text-md font-medium text-gray-900 dark:text-gray-300 grid">Bukti
                            Lainnya</label>
                        <div class="flex-[2]">
                            <select id="countries"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-8/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
